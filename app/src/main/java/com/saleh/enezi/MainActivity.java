...
public class MainActivity extends Activity {
    ...
    void transfers(){
        ...
        LinearLayout b=new LinearLayout(this);b.setOrientation(LinearLayout.HORIZONTAL);b.setLayoutDirection(View.LAYOUT_DIRECTION_RTL);b.addView(transferReceiverName,new LinearLayout.LayoutParams(0,dp(40),1.45f));LinearLayout q=new LinearLayout.LayoutParams(0,dp(40),1);q.setMargins(dp(5),0,0,0);b.addView(transferReceiverPhone,q);Button rc=button("📇");rc.setOnClickListener(v->{transferContactNameTarget=transferReceiverName;transferContactPhoneTarget=transferReceiverPhone;openTransferContactPicker();});LinearLayout rp=new LinearLayout.LayoutParams(dp(42),dp(40));rp.setMargins(dp(5),0,0,0);b.addView(rc,rp);f.addView(b);addSpaceTo(f,4);
