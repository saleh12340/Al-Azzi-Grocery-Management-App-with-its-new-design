...
public class MainActivity extends Activity {
    ...
    void transfers(){
        ...
        LinearLayout a=new LinearLayout(this);a.setOrientation(LinearLayout.HORIZONTAL);a.setLayoutDirection(View.LAYOUT_DIRECTION_RTL);a.addView(transferSenderName,new LinearLayout.LayoutParams(0,dp(40),1.45f));LinearLayout p=new LinearLayout.LayoutParams(0,dp(40),1);p.setMargins(dp(5),0,0,0);a.addView(transferSenderPhone,p);Button pc=button("📇");pc.setOnClickListener(v->{transferContactNameTarget=transferSenderName;transferContactPhoneTarget=transferSenderPhone;openTransferContactPicker();});LinearLayout pp=new LinearLayout.LayoutParams(dp(42),dp(40));pp.setMargins(dp(5),0,0,0);a.addView(pc,pp);f.addView(a);addSpaceTo(f,4);
